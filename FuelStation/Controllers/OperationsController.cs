...
namespace FuelStation.Controllers
{
    public class OperationsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["TankID"] = new SelectList(_context.Tanks, "TankID", "TankID");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("OperationID,FuelID,TankID,Inc_Exp,Date")] Operation operation)
        {
            ...
            ViewData["FuelID"] = new SelectList(_context.Fuels, "FuelID", "FuelID", operation.FuelID);
            ViewData["TankID"] = new SelectList(_context.Tanks, "TankID", "TankID", operation.TankID);
            return View(operation);
        }
